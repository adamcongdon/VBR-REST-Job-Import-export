function Export-VbrEncryptionPasswords {
    <#
    .SYNOPSIS
        Exports VBR encryption-password entries via the Automation REST API.
    .DESCRIPTION
        POSTs to /api/v1/automation/encryptionPasswords/export with body
    ...
    return Invoke-VbrExport -Token $Token -Resource 'encryptionPasswords' -Names $Names
}
