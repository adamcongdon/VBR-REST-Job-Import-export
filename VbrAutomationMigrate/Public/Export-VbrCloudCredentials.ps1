function Export-VbrCloudCredentials {
    <#
    .SYNOPSIS
        Exports VBR cloud-credential entries via the Automation REST API.
    .DESCRIPTION
        POSTs to /api/v1/automation/cloudCredentials/export with body
    ...
    return Invoke-VbrExport -Token $Token -Resource 'cloudCredentials' -Names $Names
}
