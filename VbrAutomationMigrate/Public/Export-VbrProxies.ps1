function Export-VbrProxies {
    <#
    .SYNOPSIS
        Exports VBR backup-proxy entries via the Automation REST API.
    .DESCRIPTION
        POSTs to /api/v1/automation/proxies/export with body
    ...
    return Invoke-VbrExport -Token $Token -Resource 'proxies' -Names $Names
}
